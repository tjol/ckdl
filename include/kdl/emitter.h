...
bool kdl_emit_arg_with_type(kdl_emitter *emitter, kdl_str type, kdl_value const *value);
bool kdl_emit_property(kdl_emitter *emitter, kdl_str name, kdl_value const *value);
bool kdl_emit_property_with_type(kdl_emitter *emitter, kdl_str name, kdl_str type, kdl_value const *value);
